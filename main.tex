...
% \definelayout[1][header=0pt, headerstate=stop]
% \setupheadertexts[\setcharacterkerning[headertracking]\WORDS{\documentvariable{title}}][{\userpagenumber}]
